...
import type { KanbanBoard, KanbanBoardTask } from "~/types/kanban";
...
const KanbanPageContent: FC<KanbanPageData> = function ({ kanbanBoards }) {
  ...
  const handleUpdateTasks = (boardId: number, tasks: KanbanBoardTask[]) => {
    setList((prevList) => updateListWithTasks(prevList, boardId, tasks));
  };
              ...
              <div className="mb-6 space-y-4">
                <ReactSortable
                  ...
                  setList={(tasks) =>
                    ...
                    //   return newList;
                    // })
                    handleUpdateTasks(board.id, tasks)
                  }
                >
